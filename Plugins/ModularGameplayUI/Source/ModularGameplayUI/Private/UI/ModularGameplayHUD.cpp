...
UModularWidgetController* AModularGameplayHUD::GetOverlayWidgetController(const FWidgetControllerParams& WCParams)
{
...
void AModularGameplayHUD::InitOverlay(AModularPlayerController* PC, AModularPlayerState* PS, UModularAbilitySystemComponent* ASC, const UAttributeSet* AS)
{
...
void AModularGameplayHUD::GetDebugActorList(TArray<AActor*>& InOutList)
{
	...
	// 收集带 AbilitySystemComponent 的 Actor 以便调试列出
