 ...
 */
UCLASS(MinimalAPI, Abstract, HideCategories=("Input"), Meta=(ShortTooltip="扩展 UGameplayAbility：ActivationGroup / ActivationPolicy、失败反馈与工具函数。"))
class UModularGameplayAbility : public UAngelscriptGASAbility
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Ability")
	UE_API UModularPawnComponent* GetHeroComponentFromActorInfo() const;
	...
	UFUNCTION(BlueprintCallable, Category = "Ability")
	UE_API void SetCameraMode(TSubclassOf<UModalCameraMode> CameraMode);
