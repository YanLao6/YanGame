...
/**
 * 使用 Unreal 内置的 NetQuantize 压缩销毁请求数据
 *
 * 原始 FRealtimeDestructionRequest: ~320 bits
 * 压缩后 FCompactDestructionOp: ~102 bits (序列化时)
 *
 * ~70% 网络带宽减少
 */
USTRUCT()
...
public:
	...
	UFUNCTION(BlueprintCallable,
		Category = "RealtimeDestructibleMesh",
