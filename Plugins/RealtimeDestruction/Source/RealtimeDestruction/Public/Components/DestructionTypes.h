...
enum class EDestructionRejectReason : uint8
{
    ...
    OutOfRange         UMETA(DisplayName = "Out of Range"),          // 超出范围
    LineOfSightBlocked UMETA(DisplayName = "Line of Sight Blocked"), // 视线被阻挡
    RateLimited        UMETA(DisplayName = "Rate Limited"),          // 速率受限
    InvalidPosition    UMETA(DisplayName = "Invalid Position"),      // 无效位置
    Indestructible     UMETA(DisplayName = "Indestructible"),        // 不可摧毁
    MaxHoleReached     UMETA(DisplayName = "Max Hole Reached")       // 达到最大孔洞数
};
