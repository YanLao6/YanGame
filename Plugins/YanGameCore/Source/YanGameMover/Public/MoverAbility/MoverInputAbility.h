...
class UMoverInputAbility : public UYanGameplayAbility, public IMoverInputProducerInterface
{
	GENERATED_BODY()
...
public:
	...
	UE_API virtual void OnAvatarSet(const FGameplayAbilityActorInfo* ActorInfo, const FGameplayAbilitySpec& Spec) override;
	...
	UE_API void ProduceMoverInput(UMoverComponent* MoverComp, int32 SimTimeMs, UPARAM(ref) FMoverInputCmdContext& InputCmd);
...
protected:
	 ...
	 */
	UE_API void CacheMoverComponent(const FGameplayAbilityActorInfo* ActorInfo);
