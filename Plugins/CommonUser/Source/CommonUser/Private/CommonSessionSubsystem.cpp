...
// Reflection in .gen.cpp only - avoid LNK2005
...
void UCommonSessionSubsystem::CreateHostReservationBeacon()
{
	...
	{
		// PIE/Listen Server 下 Beacon 常初始化失败，不断言，直接跳过 Beacon 流程
		UE_LOG(LogCommonSession, Warning, TEXT("CreateHostReservationBeacon: InitHost failed (e.g. PIE), continuing without beacon."));
